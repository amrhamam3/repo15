...
class ViewerFragment : Fragment() {
    ...
    ) { uri: Uri? -> if (uri != null) loadSTLFile(uri) }
    ...
    // أنيميشن دخول أزرار الـ toolbar بأسلوب ألعاب
    ...
    // أنيميشن ضغط الأزرار (Blur game style)
    ...
    private fun handleMeasurementTap(screenX: Float, screenY: Float) {
        ...
        val ray = RayPicker.screenPointToRay(screenX, screenY,
            ...
            renderer.getCurrentModelMatrix(), renderer.getCurrentViewMatrix(), renderer.getCurrentProjectionMatrix())
